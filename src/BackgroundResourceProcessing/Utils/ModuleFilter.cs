...
internal readonly struct ModuleFilter(Func<PartModule, bool> filter, string expansion)
{
    ...
    private ref struct Parser(string expr, ConfigNode node)
    {
        ...
        private FilterExpr ParseNotExpression()
        {
            ...
            return new(Expression.Invoke(Expression.Constant(func), expr.expr), $"!{expr.text}");
        }
        ...
        private FilterExpr ParseComparisonExpression()
        {
            ...
            return op switch
            {
                ...
                _ => throw new NotImplementedException($"Unimplemented comparison operator {op}"),
            };
        }
    ...
    private ref struct Lexer
    {
        ...
        public readonly ModuleFilterException RenderError(string message, int offset = -1)
        {
            ...
            return new ModuleFilterException($"{message}\n | {s}\n | {new string(' ', offset)}^");
        }
    ...
    private readonly ref struct TokenSpan(ReadOnlySpan<char> span)
    {
        ...
        public static bool operator !=(TokenSpan span, ReadOnlySpan<char> str) => !(span == str);
